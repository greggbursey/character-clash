...
const processedData = charactersData.map(char => {
  return {
    ...char,
    // Use the exact same image for the background, we will blur it in CSS
    backgroundUrl: char.previewUrl
  };
});
...
console.log('Successfully updated characters with 100% reliable real images from cdn.jsdelivr.net!');
